...
Mapping one variable to multiple aesthetics is not a good idea because is redundant. Use different variables and the plot will show more information about your dataset. The next plot uses four different variables in aesthetics, which gives useful aditional information when compared to all the previous plots.
